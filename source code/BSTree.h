// -------------------------------------------------------------------------------------------
// Class Description: To store movies data based on required order as a data structure.
// Give template class BSTree's specification of data members and functions.
// Give template class BSTree's implementation of data members and functions.
// -------------------------------------------------------------------------------------------
...
public:
    // ------------------------------------default constructor----------------------------
    // Description: creates an BSTree object
    BSTree()
    {
        root = NULL;
    }
    ...
    // ------------------------------------destructor--------------------------------------
    // Description: destructs BSTree object
    ~BSTree()
    {
        makeEmpty();
    }
    ...
    // ------------------------------------isEmpty------------------------------------------------
    // Description: checks whether BST is empty
    bool isEmpty() const
    {
        return (root == NULL);
    }
